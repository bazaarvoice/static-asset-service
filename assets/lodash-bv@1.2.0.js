define('lodash-bv@1.2.0', function () {
   ...
   * Build: `lodash -o /Users/oliver.wong/code/firebird/static/dev/scripts/vendor/lodash.js underscore exports="amd,node"`
   * Copyright 2012-2013 The Dojo Foundation <http://dojofoundation.org/>
   * Based on Underscore.js 1.4.4 <http://underscorejs.org/>
   * Copyright 2009-2013 Jeremy Ashkenas, DocumentCloud Inc.
   * Available under MIT license <http://lodash.com/license>
   */
    /** ===== BAZAARVOICE MODIFICATIONS =====
     * Added an `isArrayLike` function from the proposed patch for underscore#2081
     * in order to work through a horrible iOS8 JIT bug
  ...
  return (function(window) {
    ...
    /** ===== BAZAARVOICE MODIFICATION =====
     * Pulling in this value for use in isArray/isArrayLike
     *
     ...
     *
     * BAZAARVOICE MODIFICATION
     * Modifications to be similar to Lodash 3.0.1, including:
     * - Length check
     * - default explicit return of false
     * - Inlining of `isObjectLike` check (first two conditions)
     */
    var isArray = nativeIsArray || function(value) {
      var length = value != null && value.length;
      return (
        value &&
        typeof value == 'object' &&
        length >= 0 &&
    ...
    /**
     * Checks to see if something is array-like (arguments, etc)
     * Pulled in from https://github.com/jashkenas/underscore/pull/2094/files#diff-0f36b362a0b81d6f4d4bfd8a7413c75dR140
     * which is a proposed patch to fix the iOS8 bug that we're seeing in CCS-2867
     *
     * @param {Mixed} collection The value to check.
     * @returns {Boolean} Returns `true` if the value is an array or appears to be array-like
     */
    ...
    function contains(collection, target) {
      var length = collection ? collection.length : 0,
          result = false;
      if (typeof length == 'number' && isArrayLike(collection)) {
    ...
    function max(collection, callback, thisArg) {
      ...
      if (!callback && typeof length == 'number' && isArrayLike(collection)) {
        while (++index < length) {
          var value = collection[index];
          if (value > result) {
            result = value;
